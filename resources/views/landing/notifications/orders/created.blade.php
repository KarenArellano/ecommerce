...
<head>
  <meta charset="utf-8">
  <title>Your Tens order is confirmed! ☀️</title>
</head>
<body>
  <head>
    <!--[if gte mso 15]>
  ...
  <body class="body" id="body" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="#C0C0C0" style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; margin: 0; padding: 0;">
    <!--[if !mso 9]><!-->
    ...
    <!--<![endif]-->
    <!-- BEGIN: CONTAINER -->
    <table class="container container_full" cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse; min-width: 100%;" role="presentation" bgcolor="#C0C0C0">
      <tbody>
        <tr>
                                  ...
                                  <tr id="section-1468267" class="section introduction">
                                    <th style="mso-line-height-rule: exactly; padding: 13px 52px;" bgcolor="#ffffff"> 
                                      ...
                                      <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0 0 13px;" align="center">
                                        <span data-key="1468267_greeting_text" style="text-align: center; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363;">{{ __('Hola :user,', ['user' => $order->user ? $order->user->first_name : 'No user']) }}
                                        </span>
                                      </p>
                                  ...
                                  <tr id="section-1468270" class="section order_number_and_date">
                                    <th style="mso-line-height-rule: exactly; padding: 13px 52px;" bgcolor="#ffffff">
                                      <h2 style="font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; color: #4b4b4b; font-size: 20px; line-height: 26px; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; margin: 0;" align="center">
                                        ...
                                        <br>
                                        <span style="font-size: 10px;"> {{ __('* Este no es un número de guía, se enviará otro correo con su numero de guía! *') }}</span>
                                      </h2>
                                                        ...
                                                        <tbody>
                                                          <tr style="font-weight: bold;">
                                                            <th width="40" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: bold; color: #666363; padding: 0px 10px 8px 0;" align="left" bgcolor="#ffffff" valign="middle">
                                                              <img width="40" style="width: 100px; vertical-align: baseline; height: auto !important; font-weight: bold;" alt="{{ $order->paid_at == 'paypal' ? 'Paid with paypal' : 'Paid with stripe'  }}" src="{{ $order->paid_at == 'paypal' ? asset('images/cards/paypal.png') : asset('images/cards/stripe_logo.png')}}">
                                                              <a href="#">
                                        ...
                                        <tbody>
                                          <tr>
                                            <th class="column_shop_block1 " width="100%" style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 14px; line-height: 24px; font-weight: 400; color: #a3a1a1; text-transform: none; padding-bottom: 13px; padding-top: 26px;" align="center" bgcolor="#ffffff">
                                              <a href="{{ url('/') }}" target="_blank" data-key="section_shop_block1" style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; font-weight: 400; text-transform: none;">
