<form id="posts-delete-{{ $post->id }}-form" action="{{ route('dashboard.posts.destroy', $post) }}" method="POST" role="form" autocomplete="off">
    @csrf @method('DELETE')
    <div class="modal fade" id="posts-delete-{{ $post->id }}-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel5" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content tx-14">
                ...
                <div class="modal-body">
                    <p>
                        <strong>
                            {{ __('¿Está seguro que quiere eliminar la publicación :name?', ['name' => $post->title]) }}
                        </strong>
                    </p>
                    <p>
                ...
                <div class="modal-footer">
                    ...
                    data-form-to-submit='posts-delete-{{ $post->id }}-form'
